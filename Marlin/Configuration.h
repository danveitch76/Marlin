...
#define STRING_CONFIG_H_AUTHOR "(Mr_Dan, Ender-3 BLTouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 (BF) - 07-APR-2021"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1250, 1250, 1250, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -11, -2.90 }
...
#if X_MIN_POS > 0
#define X_BED_SIZE (X_MAX_POS - 1 - X_MIN_POS)
#else
#define X_BED_SIZE X_MAX_POS
#endif
#if Y_MIN_POS > 0
#define Y_BED_SIZE (Y_MAX_POS - 1 - Y_MIN_POS)
#else
